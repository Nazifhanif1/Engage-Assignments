...
public class SightingDaoDBImpl implements SightingDao {
    ...
    private Superhero getHeroForSighting(Sighting sighting) {
        final String SELECT_HERO_FOR_SIGHTING = "SELECT s.* FROM superhero s "
                + "JOIN sighting si ON s.superheroId = si.heroId WHERE si.sightingId = ?";
    ...
    public Sighting createSighting(Sighting sighting) {
        final String INSERT_SIGHTING = "INSERT INTO sighting(sightingDate, heroId, locId) VALUES(?,?,?)";
    ...
    public void updateSighting(Sighting sighting) {
        // deleteSightingById(sighting.getSightingId());
        final String UPDATE_SIGHTING = "UPDATE sighting "
                + "SET sightingDate = ?, heroId = ?, locId = ? WHERE sightingId = ?";
